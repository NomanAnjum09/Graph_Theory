...
def vp_start_gui():
    ...
    Label(root, foreground="#5abfb8" ,background="#1e2c63", text="Noman Anjum           17K-3755" ,font=("Helvetica",25)).pack()
    Label(root, foreground="#5abfb8" ,background="#1e2c63", text="Muhammad Ahsan Siddiq 17K-3650" ,font=("Helvetica",25)).pack()
    Label(root, foreground="#5abfb8" ,background="#1e2c63",  font=my_font).pack()
    Label(root, foreground="#5abfb8" ,background="#1e2c63", font=my_font).pack()
    Label(root, foreground="#5abfb8" ,background="#1e2c63", text="Please Wait While Loading ..." ,font=my_font).pack()
...
filename = PhotoImage(file = "select.png")
